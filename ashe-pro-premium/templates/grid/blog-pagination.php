...
<nav class="blog-pagination clear-fix <?php echo esc_attr__( $post_pagination ); ?>" data-max-pages="<?php echo esc_attr( $wp_query->max_num_pages ); ?>" data-loading="<?php esc_attr_e( 'Loading...', 'ashe-pro' ); ?>" >
