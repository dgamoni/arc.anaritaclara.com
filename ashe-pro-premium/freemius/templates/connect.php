		...
		<div class="fs-content">
			...
			<p><?php
					...
					if ( $is_pending_activation ) {
						...
						$button_label = fs_text_inline( 'Activate License', 'agree-activate-license', $slug );

						echo $fs->apply_filters( 'connect-message_on-premium',
							/* translators: %s: name (e.g. Hey John,) */
							sprintf( fs_text_inline( 'Thanks for purchasing %s!%s %sTo receive further automatic theme updates, please enter your license key:%s', 'thanks-for-purchasing', $slug ), '<b>' . $fs->get_plugin_name() . '</b>', '<br>', '<span>', '<span>' ),
							$first_name,
							$fs->get_plugin_name()
						);
					} else {
			...
			<?php if ( $require_license_key ) : ?>
				<div class="fs-license-key-container">
					...
					<a class="show-license-resend-modal show-license-resend-modal-<?php echo $fs->get_unique_affix() ?> button-secondary"
					   href="#"><?php fs_esc_html_echo_inline( "Get my License Key", 'cant-find-license-key', $slug ); ?></a>
					   <div class="wproyal-get-license-video"><a href="https://www.youtube.com/watch?v=dco0ngHAvHg" target="_blank">
					   <strong>Watch the Video Guide</strong></a> - how to Get a License Key and Activate the theme.<br>
					   <em>If you are having Trouble getting a License Key, please <a href="https://wp-royal.com/contact/?ref=ashe-pro-backend-theme-license/" target="_blank">contact us.</a>
					   </div>
				</div>
			<?php endif ?>
		</div>
