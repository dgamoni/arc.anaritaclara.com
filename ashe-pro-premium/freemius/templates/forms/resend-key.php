...
HTML;
	...
	$message_above_input_field = fs_esc_html_inline( "Enter the email address you've used for the theme purchase and we will send you the license key.", 'ask-for-upgrade-email-address', $slug );
